...
/* Option to use system getline() */
#define USE_GETLINE 0
#define USE_STRTOK 0

/* History file and max length */
...
/**
 * struct passinfo - contains arguments to pass into functions,
