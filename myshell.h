...
typedef struct MyShellInfo {
    ...
    char *myshell_fname;
    list_t *myshell_env;
    list_t *myshell_history;
    list_t *myshell_alias;
...
/* myshell_lists.c */
list_t *myshell_add_node(list_t **, const char *, int);
list_t *myshell_add_node_end(list_t **, const char *, int);
size_t myshell_print_list_str(const list_t *);
int myshell_delete_node_at_index(list_t **, unsigned int);
void myshell_free_list(list_t **);

/* myshell_lists1.c */
size_t myshell_list_len(const list_t *);
char **myshell_list_to_strings(list_t *);
size_t myshell_print_list(const list_t *);
list_t *myshell_node_starts_with(list_t *, char *, char);
ssize_t myshell_get_node_index(list_t *, list_t *);
